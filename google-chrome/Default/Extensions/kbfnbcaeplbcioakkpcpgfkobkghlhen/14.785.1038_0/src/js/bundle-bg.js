!function e(t, n, r) {
    ...
    150: [ function(require, module, exports) {
        ...
        !function(AppConfig) {
            function create(browser, env) {
                ...
                return {
                    url: url_1.UrlConfig.create(grammarlyProdDomain, felogUrl),
    ...
    154: [ function(require, module, exports) {
        (function(process) {
            ...
            !function(ProcessEnv) {
                function create(env, major_number, build_number, release_number, git_branch, git_commit) {
                    return {
                        env: env,
                ...
                function fromBrowserify() {
                    return create("prod", "14", "785", "1038", process.env.GIT_BRANCH, "9e2adfeb2ad2610ab5df79c7968cd0a69cf47bf5");
                }
            ...
            !function(MainConfig) {
                function create(browser, context, processEnv) {
                    ...
                    return {
                        ...
                        appConfig: app_1.AppConfig.create(browser, env),
    ...
    157: [ function(require, module, exports) {
        ...
        var UrlConfig;
        !function(UrlConfig) {
            function create(grammarlyDomain, felogUrl) {
    ...
    163: [ function(require, module, exports) {
        ...
        function isPopup(url) {
            if (!url) return !1;
            var mozPopupRegex = /^moz-extension:\/\/.*\/src\/popup.html$/, edgePopupRegex = /^ms-browser-extension:\/\/.*\/src\/popup.html$/, chromePopupRegex = chrome.runtime ? new RegExp(chrome.runtime.id + "/src/popup.html") : void 0;
            return edgePopupRegex.test(url) || chromePopupRegex && chromePopupRegex.test(url) || mozPopupRegex.test(url);
        }
        ...
        var helpers_1 = require("./helpers"), util_1 = require("lib/util"), interface_1 = require("../interface");
            ...
            function GenericBackgroundMessageApiImpl(onPortConnection, _getActiveTab, _getAllTabs) {
                ...
                this._tabPorts = {
                    ...
                    if (port.name === interface_1.ports.bridge) port.onMessage(function(msg) {
                        ...
                        if (sender) {
                            if (sender.tab) {
                                var _sender$tab = sender.tab, id = _sender$tab.id, url = _sender$tab.url;
                                if (id) {
                                    var ports = _this._tabPorts[id];
                                    void 0 === ports && (ports = _this._tabPorts[id] = []), ports.push(port);
                                }
                                url && 0 === url.indexOf("http") && _this._messageHelper.fire("tab-connected", {
                                    tab: id,
                                    url: url
    ...
    164: [ function(require, module, exports) {
        ...
        var _promise = require("babel-runtime/core-js/promise"), _promise2 = _interopRequireDefault(_promise), _classCallCheck2 = require("babel-runtime/helpers/classCallCheck"), _classCallCheck3 = _interopRequireDefault(_classCallCheck2), _createClass2 = require("babel-runtime/helpers/createClass"), _createClass3 = _interopRequireDefault(_createClass2);
        Object.defineProperty(exports, "__esModule", {
            value: !0
        });
        var helpers_1 = require("./helpers"), util_1 = require("lib/util"), interface_1 = require("../interface"), GenericContentScriptMessageApiImpl = function() {
    ...
    167: [ function(require, module, exports) {
        ...
        var chrome_util_1 = require("../chrome-util"), ChromeTabsApiImpl = function() {
                ...
                value: function() {
                    return new _promise2["default"](function(resolve, reject) {
                        ...
                        ct.query({
                            ...
                            chrome_util_1.handleChromeError(function() {
                                return tabs && tabs.length ? resolve(tabs[0]) : ct.query({
                                    active: !0
                                }, function(tabs) {
                                    chrome_util_1.handleChromeError(function() {
                ...
                value: function(listener, error) {
                    ...
                    chrome.tabs.onActivated.addListener(function(activeTab) {
                        ...
                        _this2.getActiveTab().then(function(tab) {
                            tab.id === tabId && (reason.url || reason.favIconUrl || "complete" === reason.status) && chrome.tabs.get(tabId, function(active) {
    ...
    169: [ function(require, module, exports) {
        ...
        "universal/bg/state/user/reducer": 234
    } ],
    170: [ function(require, module, exports) {
                                ...
                                return _regenerator2["default"].wrap(function(_context4) {
                                    for (;;) switch (_context4.prev = _context4.next) {
                                      ...
                                      case 5:
                                        ...
                                        fromBlog = url.includes(config_1.GRAMMARLY_DOMAIN + "/blog"), _context4.abrupt("return", fromBlog ? "blog" : fromFunnel ? "funnel" : "webstore");
        ...
        function openWelcome(funnel) {
            if (!util_1.isChrome() || !funnel) {
                var url = util_1.isChrome() ? config_1.URLS.welcomeC : config_1.URLS.authCreatePage + "/?extension_install=true", tabs = extensionApi.tabs;
        ...
        "lib/timers": 195,
        lodash: "lodash",
        "universal/bg/prefs": 213,
        "universal/bg/socket": 215,
        "universal/bg/state/connection/sagas": 220,
        "universal/bg/state/settings/sagas": 225,
        "universal/bg/state/tabs/sagas": 230,
        "universal/bg/state/user/sagas": 235,
        "universal/bg/store": 237,
        "universal/bg/util": 238,
    ...
    197: [ function(require, module, exports) {
        ...
        !function(bgPageCallImpls) {
            ...
            !function(methods) {
                ...
                methods.sendFelog = sendFelog, methods.setUserId = setUserId, methods.setContainerId = setContainerId;
    ...
    199: [ function(require, module, exports) {
        ...
        var timeseries_impl_1 = require("@grammarly-npm/telemetry.ts/lib/timeseries_impl"), felog_1 = require("./felog"), DefaultFelogClient = function() {
    ...
    202: [ function(require, module, exports) {
        ...
        exports.logger = new telemetry_1.Telemetry(call_1.callBgPage.sendFelog.bind(call_1.callBgPage), call_1.callBgPage.setUserId.bind(call_1.callBgPage), call_1.callBgPage.setContainerId.bind(call_1.callBgPage)), 
    ...
    203: [ function(require, module, exports) {
        ...
        }), (0, _defineProperty3["default"])(_exports$on, "tab-connected", function(id, _ref, _ref2) {
            var enabled = _ref.enabled, cookiesDisabled = _ref2.cookiesDisabled;
            this["daily-ping"](id, cookiesDisabled), enabled || logger_1.logger.disabledOnDomain();
    ...
    204: [ function(require, module, exports) {
        ...
        var felog_1 = require("./felog"), CARD_EVENTS_PROBABILITY = .1, PROXY_EVENTS_PROBABILITY = .05, Telemetry = function() {
            function Telemetry(_sendFelog, _setUserId, _setContainerId) {
                var _this = this;
                (0, _classCallCheck3["default"])(this, Telemetry), this._sendFelog = _sendFelog, 
                this._setUserId = _setUserId, this._setContainerId = _setContainerId, this.pageLoadTimeout = function() {
    ...
    214: [ function(require, module, exports) {
        ...
        var emitter = require("emitter"), util_1 = require("lib/util"), lodash_1 = require("lodash"), FakeCapi = function FakeCapi() {
            ...
            this._isAutorun = !1, this._latestRevision = 0, this.isOn = function() {
                ...
                return ws;
            }, this._socket = this._fakeWebsocket(), this._debouncedRunFakeCapi = lodash_1.debounce(this.run, 500);
        };
    ...
    217: [ function(require, module, exports) {
        ...
        "./connection/actions": 218,
        "./settings/actions": 222,
        "./user/actions": 232,
        "babel-runtime/core-js/object/assign": 19
    } ],
                ...
                value: _regenerator2["default"].mark(function listenNewTabsConnections() {
                    ...
                    return _regenerator2["default"].wrap(function(_context2) {
                        for (;;) switch (_context2.prev = _context2.next) {
                          ...
                          case 24:
                            return _context2.next = 26, effects_1.call(tracking_1.fire, "tab-connected", state.user.id, state.config, state.connection);

                          case 26:
                            return pageState = selectors_1.stateForTab(state), _context2.next = 29, effects_1.call(this._emitTo, tab, "state", pageState);
    ...
    237: [ function(require, module, exports) {
        ...
        "./state/actions": 217,
        "./state/connection/reducer": 219,
        "./state/settings/reducer": 224,
        "./state/tabs/reducer": 229,
        "./state/user/reducer": 234,
        "babel-runtime/helpers/classCallCheck": 29,
        "babel-runtime/helpers/createClass": 30,
        "babel-runtime/regenerator": 37,
        "lib/config": 179,
