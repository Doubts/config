!function e(t, n, o) {
    ...
    50: [ function(e, t, n) {
        var o = e("./_global"), r = e("./_core"), i = e("./_ctx"), s = e("./_hide"), c = "prototype", a = function(e, t, n) {
            var u, l, f, d = e & a.F, p = e & a.G, _ = e & a.S, g = e & a.P, b = e & a.B, h = e & a.W, v = p ? r : r[t] || (r[t] = {}), m = v[c], y = p ? o : _ ? o[t] : (o[t] || {})[c];
            p && (n = t);
            ...
            v[u] = p && "function" != typeof y[u] ? n[u] : b && l ? i(f, o) : h && y[u] == f ? function(e) {
                ...
                return t[c] = e[c], t;
            }(f) : g && "function" == typeof f ? i(Function.call, f) : f, g && ((v.virtual || (v.virtual = {}))[u] = f, 
            e & a.R && m && !m[u] && s(m, u, f)));
        };
    ...
    52: [ function(e, t, n) {
        var o = e("./_ctx"), r = e("./_iter-call"), i = e("./_is-array-iter"), s = e("./_an-object"), c = e("./_to-length"), a = e("./core.get-iterator-method"), u = {}, l = {}, n = t.exports = function(e, t, n, f, d) {
            var p, _, g, b, h = d ? function() {
                return e;
            } : a(e), v = o(n, f, t ? 2 : 1), m = 0;
            if ("function" != typeof h) throw TypeError(e + " is not iterable!");
            if (i(h)) {
                for (p = c(e.length); p > m; m++) if (b = t ? v(s(_ = e[m])[0], _[1]) : v(e[m]), 
                b === u || b === l) return b;
            } else for (g = h.call(e); !(_ = g.next()).done; ) if (b = r(g, v, _.value, t), 
            b === u || b === l) return b;
        };
    ...
    65: [ function(e, t, n) {
        "use strict";
        var o = e("./_library"), r = e("./_export"), i = e("./_redefine"), s = e("./_hide"), c = e("./_has"), a = e("./_iterators"), u = e("./_iter-create"), l = e("./_set-to-string-tag"), f = e("./_object-gpo"), d = e("./_wks")("iterator"), p = !([].keys && "next" in [].keys()), _ = "@@iterator", g = "keys", b = "values", h = function() {
            return this;
        };
        t.exports = function(e, t, n, v, m, y, j) {
            ...
            }, O = t + " Iterator", N = m == b, I = !1, E = e.prototype, C = E[d] || E[_] || m && E[m], P = C || k(m), F = m ? N ? k("entries") : P : void 0, S = "Array" == t ? E.entries || C : C;
            if (S && (L = f(S.call(new e())), L !== Object.prototype && (l(L, O, !0), o || c(L, d) || s(L, d, h))), 
            N && C && C.name !== b && (I = !0, P = function() {
                return C.call(this);
            }), o && !j || !p && !I && E[d] || s(E, d, P), a[t] = P, a[O] = h, m) if (w = {
                values: N ? P : k(b),
                keys: y ? P : k(g),
                entries: F
            }, j) for (x in w) x in E || i(E, x, w[x]); else r(r.P + r.F * (p || I), t, w);
            return w;
        };
    }, {
        "./_export": 50,
    ...
    71: [ function(e, t, n) {
        var o = e("./_uid")("meta"), r = e("./_is-object"), i = e("./_has"), s = e("./_object-dp").f, c = 0, a = Object.isExtensible || function() {
            ...
            return u && _.NEED && a(e) && !i(e, o) && l(e), e;
        }, _ = t.exports = {
            KEY: o,
            NEED: !1,
            fastKey: f,
    ...
    73: [ function(e, t, n) {
        ...
        t.exports = !a || e("./_fails")(function() {
            ...
            for (var n = s(e), a = arguments.length, u = 1, l = r.f, f = i.f; a > u; ) for (var d, p = c(arguments[u++]), _ = l ? o(p).concat(l(p)) : o(p), g = _.length, b = 0; g > b; ) f.call(p, d = _[b++]) && (n[d] = p[d]);
            return n;
        } : a;
    }, {
        "./_fails": 51,
    ...
    96: [ function(e, t, n) {
        var o, r, i, s = e("./_ctx"), c = e("./_invoke"), a = e("./_html"), u = e("./_dom-create"), l = e("./_global"), f = l.process, d = l.setImmediate, p = l.clearImmediate, _ = l.MessageChannel, g = 0, b = {}, h = "onreadystatechange", v = function() {
            var e = +this;
        ...
        d && p || (d = function(e) {
            ...
            f.nextTick(s(v, e, 1));
        } : _ ? (r = new _(), i = r.port2, r.port1.onmessage = m, o = s(i.postMessage, i, 1)) : l.addEventListener && "function" == typeof postMessage && !l.importScripts ? (o = function(e) {
            l.postMessage(e + "", "*");
    ...
    110: [ function(e, t, n) {
        ...
        r(r.S + r.F * !e("./_iter-detect")(function(e) {
            ...
            from: function(e) {
                var t, n, r, f, d = i(e), p = "function" == typeof this ? this : Array, _ = arguments.length, g = _ > 1 ? arguments[1] : void 0, b = void 0 !== g, h = 0, v = l(d);
                if (b && (g = o(g, _ > 2 ? arguments[2] : void 0, 2)), void 0 == v || p == Array && c(v)) for (t = a(d.length), 
                n = new p(t); t > h; h++) u(n, h, b ? g(d[h], h) : d[h]); else for (f = v.call(d), 
                n = new p(); !(r = f.next()).done; h++) u(n, h, b ? s(f, g, [ r.value, h ], !0) : r.value);
                return n.length = h, n;
            }
        });
    }, {
    ...
    119: [ function(e, t, n) {
        "use strict";
        var o, r, i, s = e("./_library"), c = e("./_global"), a = e("./_ctx"), u = e("./_classof"), l = e("./_export"), f = e("./_is-object"), d = e("./_a-function"), p = e("./_an-instance"), _ = e("./_for-of"), g = e("./_species-constructor"), b = e("./_task").set, h = e("./_microtask")(), v = "Promise", m = c.TypeError, y = c.process, j = c[v], y = c.process, w = "process" == u(y), x = function() {}, L = !!function() {
            try {
            ...
            b.call(c, function() {
                ...
                }), e._h = w || F(e) ? 2 : 1), e._a = void 0, t) throw t.error;
            });
        }, F = function(e) {
            if (1 == e._h) return !1;
            for (var t, n = e._a || e._c, o = 0; n.length > o; ) if (t = n[o++], t.fail || !F(t.promise)) return !1;
            return !0;
        }, S = function(e) {
            b.call(c, function() {
                var t;
        ...
        L || (j = function(e) {
            ...
            then: function(e, t) {
                ...
                n.domain = w ? y.domain : void 0, this._c.push(n), this._a && this._a.push(n), this._s && C(this, !1), 
                n.promise;
            },
            "catch": function(e) {
        ...
        l(l.S + l.F * !L, v, {
            ...
            all: function(e) {
                var t = this, n = N(t), o = n.resolve, r = n.reject, i = E(function() {
                    var n = [], i = 0, s = 1;
                    _(e, !1, function(e) {
                        var c = i++, a = !1;
            ...
            race: function(e) {
                var t = this, n = N(t), o = n.reject, r = E(function() {
                    _(e, !1, function(e) {
    ...
    121: [ function(e, t, n) {
        "use strict";
        var o = e("./_global"), r = e("./_has"), i = e("./_descriptors"), s = e("./_export"), c = e("./_redefine"), a = e("./_meta").KEY, u = e("./_fails"), l = e("./_shared"), f = e("./_set-to-string-tag"), d = e("./_uid"), p = e("./_wks"), _ = e("./_wks-ext"), g = e("./_wks-define"), b = e("./_keyof"), h = e("./_enum-keys"), v = e("./_is-array"), m = e("./_an-object"), y = e("./_to-iobject"), j = e("./_to-primitive"), w = e("./_property-desc"), x = e("./_object-create"), L = e("./_object-gopn-ext"), k = e("./_object-gopd"), O = e("./_object-dp"), N = e("./_object-keys"), I = k.f, E = O.f, C = L.f, P = o.Symbol, F = o.JSON, S = F && F.stringify, M = "prototype", R = p("_hidden"), A = p("toPrimitive"), T = {}.propertyIsEnumerable, W = l("symbol-registry"), B = l("symbols"), U = l("op-symbols"), D = Object[M], V = "function" == typeof P, G = o.QObject, z = !G || !G[M] || !G[M].findChild, q = i && u(function() {
            return 7 != x(E({}, "a", {
                get: function() {
                    return E(this, "a", {
                        value: 7
            ...
            var o = I(D, t);
            o && delete D[t], E(e, t, n), o && e !== D && E(D, t, o);
        } : E, J = function(e) {
            var t = B[e] = x(P[M]);
            return t._k = e, t;
        }, H = V && "symbol" == typeof P.iterator ? function(e) {
            return "symbol" == typeof e;
        } : function(e) {
            return e instanceof P;
        }, K = function(e, t, n) {
            return e === D && K(U, t, n), m(e), t = j(t, !0), m(n), r(B, t) ? (n.enumerable ? (r(e, R) && e[R][t] && (e[R][t] = !1), 
            n = x(n, {
                enumerable: w(0, !1)
            })) : (r(e, R) || E(e, R, w(1, {})), e[R][t] = !0), q(e, t, n)) : E(e, t, n);
        }, Y = function(e, t) {
            m(e);
            ...
            return !(this === D && r(B, e) && !r(U, e)) && (!(t || !r(this, e) || !r(B, e) || r(this, R) && this[R][e]) || t);
        }, Z = function(e, t) {
            if (e = y(e), t = j(t, !0), e !== D || !r(B, t) || r(U, t)) {
                var n = I(e, t);
                return !n || !r(B, t) || r(e, R) && e[R][t] || (n.enumerable = !0), n;
            }
        }, $ = function(e) {
            for (var t, n = C(y(e)), o = [], i = 0; n.length > i; ) r(B, t = n[i++]) || t == R || t == a || o.push(t);
            return o;
        }, ee = function(e) {
            for (var t, n = e === D, o = C(n ? U : y(e)), i = [], s = 0; o.length > s; ) !r(B, t = o[s++]) || n && !r(D, t) || i.push(B[t]);
            return i;
        };
        V || (P = function() {
            if (this instanceof P) throw TypeError("Symbol is not a constructor!");
            var e = d(arguments.length > 0 ? arguments[0] : void 0), t = function(n) {
                this === D && t.call(U, n), r(this, R) && r(this[R], e) && (this[R][e] = !1), q(this, e, w(1, n));
            };
            return i && z && q(D, e, {
                configurable: !0,
                set: t
        ...
        for (var te = N(p.store), ne = 0; te.length > ne; ) g(te[ne++]);
        s(s.S + s.F * !V, "Symbol", {
            "for": function(e) {
    ...
    125: [ function(e, t, n) {
        ...
        function c() {
            b && _ && (b = !1, _.length ? g = _.concat(g) : h = -1, g.length && a());
        }
        function a() {
            if (!b) {
                var e = i(c);
        ...
        p.nextTick = function(e) {
            ...
            g.push(new u(e, t)), 1 !== g.length || b || i(a);
    ...
    126: [ function(e, t, n) {
        ...
        function r() {
            ...
            function r(e) {
                ...
                return t.onMessage.addListener(function(t) {
                    ...
                    _.proxyPortDisconnected(e, t && t.message || "port malfunction: " + e), o(), document.dispatchEvent(new CustomEvent("grammarly:error", {
                        detail: {
                            event: "disconnect",
                            name: e
                        }
        ...
        var l = e("lib/tracking/felogPixel"), f = e("lib/tracking/telemetry"), d = e("extension-api/interface"), p = window.chrome || window.firefox, _ = new f.Telemetry(l.sendEventPixel, function() {}, function() {});
    ...
    127: [ function(e, t, n) {
        ...
        !function(e) {
            function t(e, t) {
                var c = "prod" === t ? "https://f-log-extension.grammarly.io" : "qa" === t || "dev" === t ? "https://127.0.0.1:8000" : r.assertNever(t), a = "prod" === t ? o : "qa" === t || "dev" === t ? "qagr.io" : r.assertNever(t);
                return {
                    url: i.UrlConfig.create(o, c),
                    gnar: s.GnarConfig.create(e, a),
            ...
            !function(e) {
                function t(e, t, n) {
                    ...
                    if (3 === d.length && d.every(function(e) {
                        ...
                        var _ = (a.BuildInfo.getManifestVersion(e, t, window) || "").split(".").map(f.optionalIntString);
                        p = 3 === _.length && _.every(function(e) {
                            return void 0 !== e;
                        }) ? _ : [ 4, 0, 2 ];
                    }
                    var g = p, b = (0, i["default"])(g, 3), h = b[0], v = b[1], m = b[2];
                    return {
                        buildInfo: a.BuildInfo.create(h, v, m, e, s, n.git_branch, n.git_commit),
                        bundleInfo: l.BundleInfo.create(e, s, t),
                        appConfig: c.AppConfig.create(e, s),
    ...
    134: [ function(e, t, n) {
        ...
        !function(e) {
            function t(e, t) {
                var n = "https://www." + e, o = "https://data." + e, r = "https://app." + e, i = "https://auth." + e + "/v3", s = "https://emailfeedback." + e;
                return {
                    app: r,
                    appPersonalDictionary: r + "/profile/dictionary",
                    capi: "wss://capi." + e + "/freews",
                    dapiMimic: o + "/api/mimic",
                    dapiProps: o + "/api/props",
                    editorDictionary: r + "/profile/dictionary",
    ...
    136: [ function(e, t, n) {
        ...
        n.getVersion = _, n.ENV = b.bundleInfo.env, n.URLS = b.appConfig.url, n.appName = b.appConfig.felog.appName, 
    ...
    137: [ function(e, t, n) {
        ...
        function r(e, t, n, o, r, i, a, u, l) {
            ...
            return u && (f.extra = u), o + "/log?json=" + encodeURIComponent((0, s["default"])(f));
        }
    ...
    139: [ function(e, t, n) {
        ...
        var l = e("./felog"), f = .1, d = .05, p = function() {
            function e(t, n, o) {
                var r = this;
                (0, c["default"])(this, e), this._sendFelog = t, this._setUserId = n, this._setContainerId = o, 
                this.pageLoadTimeout = function() {
                    r._send("cs.connection.failover.pageLoad.timeout", "content script init failed", l.LogLevel.ERROR);
                }, this.appLoadTimeout = function() {
                    r._send("cs.connection.failover.appLoad.timeout", "extension init timed out", l.LogLevel.ERROR);
                }, this.differentStateDomain = function(e) {
                    r._send("cs.state.differentDomain", "received state for different domain", l.LogLevel.INFO, {
                        stateDomain: e
                    });
                }, this.restoredBgConnection = function(e) {
                    r._send("cs.connection.bg.restored", "bg page connection restored", l.LogLevel.INFO, {
                        timeWithoutConnection: e
                    });
                }, this.initWithoutBgConnection = function() {
                    r._send("cs.connection.bg.disconnected", "no connection to bg page", l.LogLevel.INFO);
                }, this.fetchDefinitionsFail = function() {
                    r._send("cs.connection.api.definition.failed", "definitions fetch failed", l.LogLevel.WARN);
                }, this.infinityCheckResetFail = function(e) {
                    r._send("cs.connection.infiniteCheck.failed", "infinite check reset failed", l.LogLevel.ERROR, {
                        delay: e
                    });
                }, this.tooLongPageConfigInit = function(e) {
                    r._send("cs.pageConfig.init.exceeded", "page config init timeout", l.LogLevel.WARN, {
                        initTime: e
                    });
                }, this.tooLongUserUpdateTime = function(e) {
                    r._send("bg.state.user.update.exceeded", "user state update took too long", l.LogLevel.WARN, {
                        updateTime: e
                    });
                }, this.lostBgPageConnection = function() {
                    r._send("cs.gbutton.bgСonnection.lost", "gbutton connection to bg page lost", l.LogLevel.INFO);
                }, this.restoreBgPageConnection = function(e) {
                    r._send("cs.gbutton.bgСonnection.restored", "gbutton connection to bg page restored", l.LogLevel.INFO, {
                        time: e
                    });
                }, this.badCursorPosition = function() {
                    r._send("cs.editor.badCursorPosition", "incorrect cursor position in grammarly-editor", l.LogLevel.INFO);
                }, this.cursorJump = function() {
                    r._send("cs.editor.cursorJump", "cursor jump detected", l.LogLevel.WARN);
                }, this.signinOpen = function() {
                    r._send("cs.signin.open", "sign in dialog opened", l.LogLevel.INFO);
                }, this.signinClose = function(e) {
                    r._send("cs.signin.close", "sign in dialog closed", l.LogLevel.INFO, {
                        openTime: e
                    });
                }, this.tabReloadClick = function() {
                    r._send("cs.gbutton.reload.click", "gbutton reload clicked", l.LogLevel.WARN);
                }, this.popupLoadError = function(e, t) {
                    r._send("cs.popup.load.error", "could not open pop-up editor", l.LogLevel.ERROR, {
                        message: e,
                        name: t
                    });
                }, this.loginNoBgPageConnection = function(e) {
                    r._send("debug.cs.connection.signin.bg.timeout", "can not connect to bg page on login", l.LogLevel.INFO, {
                        message: e
                    });
                }, this.pageConfigCDNError = function(e) {
                    r._send("cs.pageConfig.cdn.error", "could not read page config", l.LogLevel.ERROR, {
                        message: e
                    });
                }, this.pageConfigLocalStorageError = function(e, t) {
                    r._send("cs.pageConfig.localStorage.error", "could not read page config from localStorage", l.LogLevel.INFO, {
                        message: e,
                        name: t
                    });
                }, this.pageConfigUpdated = function(e, t) {
                    r._send("cs.pageConfig.updated", "page config updated", l.LogLevel.INFO, {
                        oldVersion: e,
                        newVersion: t
                    });
                }, this.settingsPopupTimeout = function() {
                    r._send("settings.popup.init.timeout", "settings popup open timeout", l.LogLevel.WARN);
                }, this.settingsUsupportedShow = function(e) {
                    r._send("settings.popup.state.unsupported.show", "page unsupported message shown", l.LogLevel.INFO, {
                        popupType: e
                    });
                }, this.settingsPopupToggled = function(e) {
                    r._send("settings.popup.experiment.toggle", "settings popup disabled/enabled for experiment on /personalize page", l.LogLevel.INFO, {
                        isPopupDisabled: e
                    });
                }, this.socketBgError = function() {
                    r._send("bg.socket.error", "bg page socket error", l.LogLevel.WARN);
                }, this.capiNotAuthorizedLoop = function(e, t) {
                    r._send("debug.socket.notAuthorizedLoop", "could not authenticate on capi and auth", l.LogLevel.INFO, {
                        authDegradation: e,
                        cookiesDisabled: t
                    });
                }, this.socketDisabledCookie = function() {
                    r._send("debug.socket.disabledCookies", "disabled cookies after failed authentication", l.LogLevel.INFO);
                }, this.socketBgRestored = function(e) {
                    r._send("debug.bg.socket.restored", "capi session restored", l.LogLevel.INFO, {
                        tryCount: e
                    });
                }, this.socketBgReconnectFail = function(e, t) {
                    r._send("bg.socket.reconnect.fail", "could not restore ws connection", l.LogLevel.WARN, {
                        token: e,
                        tryCount: t
                    });
                }, this.socketCsError = function() {
                    r._send("cs.socket.error", "content script socket error", l.LogLevel.WARN);
                }, this.soketCsErrorMsg = function(e) {
                    r._send("cs.socket.errorMsg", "capi error", l.LogLevel.WARN, {
                        message: e
                    });
                }, this.gnarClientInitFail = function(e) {
                    r._send("gnar.bg.tracking.gnar.init.fail", "gnar init failed", l.LogLevel.WARN, {
                        message: e
                    });
                }, this.bgTrackingInitFail = function() {
                    r._send("debug.tracking.init.fail", "bg page tracking library init failed", l.LogLevel.INFO);
                }, this.dailyPing = function() {
                    r._send("debug.dailyPing", "daily ping", l.LogLevel.INFO);
                }, this.userUpgradeClick = function(e) {
                    r._send("cs.ui.action.upgradeClick", "upgrade hook clicked", l.LogLevel.INFO, {
                        placement: e
                    });
                }, this.gButtonClick = function() {
                    r._send("cs.ui.gbutton.click", "gbutton clicked", l.LogLevel.INFO);
                }, this.checkingToggledInField = function(e) {
                    r._send("cs.ui.gbutton.toggleInField", "checking toggled in field", l.LogLevel.INFO, {
                        enabled: e
                    });
                }, this.disabledOnDomain = function() {
                    r._send("cs.state.disabledOnDomain", "checking disabled for domain", l.LogLevel.INFO);
                }, this.sessionInvalidated = function(e, t) {
                    r._send("bg.session.invalidated", "user session invalidated", l.LogLevel.INFO, {
                        reason: e,
                        userChanged: t
                    });
                }, this.unexpectedAnonymous = function(e) {
                    r._send("debug.bg.session.unexpectedAnonymous", "user changed to anonymous", l.LogLevel.INFO, e);
                }, this.dapiPropInitialized = function(e, t) {
                    r._send("bg.settings.dapi.prop.init", "save property to the DAPI", l.LogLevel.INFO, {
                        name: e,
                        value: t
                    });
                }, this.getDapiPropError = function(e, t) {
                    r._send("bg.connection.dapi.getProp.error", "could not get dapi property", l.LogLevel.WARN, {
                        property: e,
                        body: t
                    });
                }, this.setDapiPropError = function(e, t) {
                    r._send("bg.connection.dapi.setProp.error", "could not set dapi property", l.LogLevel.WARN, {
                        property: e,
                        body: t
                    });
                }, this.toggleExtensionDefs = function(e) {
                    r._send("bg.settings.definitions.toggle", "definitions toggled for domain", l.LogLevel.INFO, {
                        enabled: e
                    });
                }, this.toggleExtension = function(e, t) {
                    r._send("bg.settings.extension.toggle", "extension toggled for domain", l.LogLevel.INFO, {
                        enabled: e,
                        placement: t
                    });
                }, this.disableUntilNextVisit = function() {
                    r._send("cs.gbutton.disableUntilNextVisit", "extension temporary disabled on the current tab", l.LogLevel.INFO);
                }, this.disableButtonClick = function() {
                    r._send("cs.gbutton.disableButtonClick", "clicked on disable button in gButton", l.LogLevel.INFO);
                }, this.cookieOverflow = function(e, t) {
                    r._send("debug.bg.state.cookie.overflow", "cookie is too big", l.LogLevel.INFO, {
                        size: e,
                        biggestCookie: t
                    });
                }, this.externalChangePlan = function() {
                    r._send("bg.api.external.changePlan", "plan changed from editor", l.LogLevel.INFO);
                }, this.externalChangeDialect = function() {
                    r._send("bg.api.external.changeDialect", "dialect changed from editor", l.LogLevel.INFO);
                }, this.externalChangeUser = function() {
                    r._send("bg.api.external.changeUsed", "user changed from editor", l.LogLevel.INFO);
                }, this.externalLogout = function() {
                    r._send("bg.api.external.logout", "user logged out form editor", l.LogLevel.INFO);
                }, this.externalEnableEmailPerception = function() {
                    r._send("bg.api.external.enableEmailPerception", "user enabled email perception feature on the funnel", l.LogLevel.INFO);
                }, this.bgPageStartFail = function(e, t) {
                    r._send("bg.start.fail", "bg page start failed", l.LogLevel.ERROR, {
                        message: e,
                        stack: t
                    });
                }, this.bgPageInitTimeout = function(e) {
                    r._send("bg.state.start.timeout", "bg page init timeout", l.LogLevel.WARN, {
                        initTime: e
                    });
                }, this.bgPageInitFail = function(e) {
                    r._send("bg.state.init.fail", "bg page init failed", l.LogLevel.ERROR, {
                        initAttempts: e
                    });
                }, this.extensionUpdated = function(e, t) {
                    r._send("bg.state.updated", "extension updated", l.LogLevel.INFO, {
                        currentVersion: e,
                        previousVersion: t
                    });
                }, this.extensionUpdateFail = function(e) {
                    r._send("bg.state.update.fail", "extension update failed", l.LogLevel.INFO, {
                        previousVersion: e
                    });
                }, this.cannotGetInstallSource = function() {
                    r._send("bg.getSource.fail", "failed to get extension install source", l.LogLevel.WARN);
                }, this.extensionInstall = function(e) {
                    r._send("bg.state.install", "extension installed", l.LogLevel.INFO, {
                        source: e
                    });
                }, this.chromeForcedToUpdate = function(e) {
                    r._send("bg.chrome.forcedToUpdate", "chrome forced update", l.LogLevel.INFO, {
                        newVersion: e
                    });
                }, this.chromeContentScriptLoadError = function(e, t) {
                    r._send("bg.chrome.cs.load.error", "content script execution error", l.LogLevel.WARN, {
                        message: e,
                        type: t
                    });
                }, this.reloadNotificationShow = function() {
                    r._send("bg.ui.notification.tabsReload.show", "extension reload notification shown", l.LogLevel.WARN);
                }, this.reloadNotificationClick = function() {
                    r._send("bg.ui.notification.tabsReload.click", "reload notification clicked", l.LogLevel.INFO);
                }, this.fetchUserFail = function(e, t, n) {
                    r._send("bg.user.fetch.fail", "failed to update user", l.LogLevel.WARN, {
                        body: t,
                        statusCode: n,
                        reason: e
                    });
                }, this.fetchMimicFail = function(e, t) {
                    r._send("bg.user.mimic.fail", "mimic request failed", l.LogLevel.WARN, {
                        body: e,
                        statusCode: t
                    });
                }, this.fetchCookieFail = function() {
                    r._send("bg.cookie.fail", "could not get grauth from cookie", l.LogLevel.WARN);
                }, this.fetchSettingsFail = function(e, t) {
                    r._send("bg.user.settings.fail", "could not get settings from auth", l.LogLevel.WARN, {
                        body: e,
                        statusCode: t
                    });
                }, this.frequentCookieChanges = function(e) {
                    r._send("debug.cookie.onChange.error", "cookie change too frequent", l.LogLevel.INFO, {
                        canceled: e
                    });
                }, this.initializePropFromDapi = function(e) {
                    r._send("bg.state.dapi.prop.initialize", "set property from dapi", l.LogLevel.INFO, {
                        name: e
                    });
                }, this.emailPerceptionPopupShow = function() {
                    r._send("cs.emailPerception.popup.show", "show email perception popup on gmail/inbox domain", l.LogLevel.INFO);
                }, this.emailPerceptionPopupCancel = function() {
                    r._send("cs.emailPerception.popup.cancel", "user canceled email perception popup on gmail/inbox", l.LogLevel.INFO);
                }, this.emailPerceptiongButtonHover = function() {
                    r._send("cs.emailPerception.gbutton.hover", "user hovered gButton and ask for feedback btn is shown on gmail/inbox", l.LogLevel.INFO);
                }, this.onboardingPopupShow = function() {
                    r._send("cs.onboarding.popup.show", "show onboarding popup to user after first time extension install", l.LogLevel.INFO);
                }, this.onboardingPopupCancel = function() {
                    r._send("cs.onboarding.popup.cancel", "user canceled onboarding popup", l.LogLevel.INFO);
                }, this.onboardingTutorialShow = function() {
                    r._send("cs.onboarding.tutorial.show", "opened onboarding dialog after popup", l.LogLevel.INFO);
                }, this.onboardingVideoLoaded = function() {
                    r._send("cs.onboarding.tutorial.video.loaded", "load video data for onboarding tutorial", l.LogLevel.INFO);
                }, this.saveEmailFeedbackError = function(e) {
                    r._send("bg.emailfeedback.save.error", "failed to save email feedback", l.LogLevel.INFO, {
                        body: e
                    });
                }, this.incognitoInit = function() {
                    r._send("bg.incognito.init", "extension initialized in incognito mode", l.LogLevel.INFO);
                }, this.disabledCookiesInit = function() {
                    r._send("bg.cookie.disabled", "extension initialized with disabled cookies", l.LogLevel.INFO);
                }, this.proxyInit = function() {
                    r._sendWithProbability(d, "proxy.init", "proxy script initialized", l.LogLevel.INFO);
                }, this.proxyPortDisconnected = function(e, t) {
                    r._sendWithProbability(d, "proxy.disconnect", "proxy port disconnected", l.LogLevel.INFO, {
                        port: e,
                        error: t
                    });
                }, this.unhandledBgPageException = function(e) {
                    r._send("bg.unhandledException", "unhandled exception on background page", l.LogLevel.ERROR, {
                        message: e.error ? e.error.message : e.message
                    });
                }, this.unhandledBgPageRejection = function(e) {
                    r._send("bg.unhandledRejection", "unhandled promise rejection on background page", l.LogLevel.ERROR, {
                        message: null != e.reason ? "string" == typeof e.reason ? e.reason : e.reason.message : void 0
                    });
                }, this.storageMigrationSucceeded = function() {
                    r._send("bg.storageMigration.success", "storage migration succeeded", l.LogLevel.INFO, {});
                }, this.storageMigrationFailed = function(e) {
                    r._send("bg.storageMigration.failure", "storage migration failed", l.LogLevel.ERROR, {
                        message: e && e.message
                    });
                }, this.cardShowAction = function() {
                    r._sendWithProbability(f, "cs.editor.card.show", "show card action", l.LogLevel.INFO);
                }, this.cardHideAction = function() {
                    r._sendWithProbability(f, "cs.editor.card.hide", "hide card action", l.LogLevel.INFO);
                }, this.cardReplacementAction = function() {
                    r._sendWithProbability(f, "cs.editor.card.replacement", "click on the replacement in the card", l.LogLevel.INFO);
                }, this.cardAddToDictAction = function() {
                    r._sendWithProbability(f, "cs.editor.card.addToDict", "click add to dictionary button in the card", l.LogLevel.INFO);
                }, this.cardIgnoreAction = function() {
                    r._sendWithProbability(f, "cs.editor.card.ignore", "click ignore button in the card", l.LogLevel.INFO);
                }, this.synonymCardShowAction = function(e) {
                    r._sendWithProbability(f, "cs.editor.synonym.show", "show synonymous card action", l.LogLevel.INFO, {
                        notFoundCard: e
                    });
                }, this.synonymCardHideAction = function(e) {
                    r._sendWithProbability(f, "cs.editor.synonym.hide", "hide synonymous card action", l.LogLevel.INFO, {
                        notFoundCard: e
                    });
                }, this.synonymReplacementAction = function() {
                    r._sendWithProbability(f, "cs.editor.synonym.replacement", "click on the replacement in the synonym", l.LogLevel.INFO);
                }, this.dictCardShowAction = function() {
                    r._sendWithProbability(f, "cs.editor.dict.show", "show dictionary card action", l.LogLevel.INFO);
                }, this.dictCardHideAction = function() {
                    r._sendWithProbability(f, "cs.editor.dict.hide", "hide dictionary card action", l.LogLevel.INFO);
                };
            }
    ...
    140: [ function(e, t, n) {
        ...
        function d(e, t) {
            return void 0 !== t ? (0, _["default"])(Array(t - e), function(t, n) {
                return n + e;
            }) : (0, _["default"])(Array(e), function(e, t) {
                return t;
            });
        }
        var p = e("babel-runtime/core-js/array/from"), _ = o(p), g = e("babel-runtime/helpers/toConsumableArray"), b = o(g);
        Object.defineProperty(n, "__esModule", {
            value: !0
    ...
    141: [ function(e, t, n) {
        ...
        function i(e, t) {
            if (null == e) throw new _(function() {
        ...
        n.AssertionError = _, n.assert = r, n.assertNonNull = i;
    }, {
    ...
    142: [ function(e, t, n) {
        ...
        var l = e("babel-runtime/core-js/object/get-prototype-of"), f = o(l), d = e("babel-runtime/helpers/possibleConstructorReturn"), p = o(d), _ = e("babel-runtime/helpers/inherits"), g = o(_), b = e("babel-runtime/helpers/classCallCheck"), h = o(b), v = e("babel-runtime/helpers/createClass"), m = o(v);
        Object.defineProperty(n, "__esModule", {
            value: !0
        });
        var y = e("./assert");
