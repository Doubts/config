...
(function (w, d, a) {
      ...
      return {
        ...
        load: function (img) {
          ...
          $.v.scaledImg = $.f.scale({
            ...
            'b': {
              'h': $.s.bd.offsetHeight - 48,
              'w': $.s.bd.offsetWidth / 2 - 20
            }
          })

          var orgCanvas = $.d.createElement('CANVAS');
          orgCanvas.height = $.a.searchResolution;
          orgCanvas.width = $.a.searchResolution;
          var orgContext = orgCanvas.getContext('2d');
          orgContext.drawImage(img, 0, 0, $.a.searchResolution, $.a.searchResolution);
        ...
        act: {
          ...
          render: function (r) {
            var i, p, thumb, mask, ft, desc, cc, tation, note;
            ...
            if (r.data.data && r.data.data.length) {
              ...
              if (r.data.annotations.length) {
                // open annotation stripe (it may already be open)
                $.s.bd.className = $.a.k + '_bd ' + $.a.k + '_hazAnno';
                for (i = 0; i < r.data.annotations.length; i = i + 1) {
                  tation = $.f.make({'SPAN':{
                    'className': $.a.k + '_tation',
                    'innerHTML': r.data.annotations[i],
                    'tation': r.data.annotations[i]
                  }});
                  tation.style.backgroundColor = '#' + noteColor[i];
                  $.s.anno.appendChild(tation);
                }
              }
        ...
        click: function (v) {
          ...
          if (el.className === $.a.k + '_tation') {
            var o = $.v.query;
            o.data.f = $.f.get(el, 'tation');
        ...
        init: function () {
          ...
          // open annotation stripe if we're speaking English
          if ($.v.lang === 'en') {
            $.s.bd.className = $.a.k + '_bd ' + $.a.k + '_hazAnno';
          }
  ...
  'msg': {
    ...
    'ja': {
      ...
      'tryAgain': '&#x518D;&#x5EA6;&#x304A;&#x8A66;&#x3057;&#x304F;&#x3060;&#x3055;&#x3044;',
      'headerMessage': '&#x4F3C;&#x305F;&#x3088;&#x3046;&#x306A;&#x30B3;&#x30F3;&#x30C6;&#x30F3;&#x30C4;&#x3092; Pinterest &#x3067;&#x63A2;&#x3059;'
    },
    'ko': {
