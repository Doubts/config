// fix empty-state and immediately-after-create state for boards
       ...
       // given window.navigator.language, return appropriate strings
        ...
        act: {
          ...
          showNewBoard: function (obj) {
            ...
            $.s.createContainer.className = $.a.k + '_createContainer';
            // zeroing out the value hides search results
            $.s.boardSearch.value = '';
            // remove everything currently in Top Choices and only show the board we just created
            $.s.topChoicesList.innerHTML = '';
            $.f.makeBoardPickerItem({'item': obj.data, 'i': -1, 'list': $.s.topChoicesList});
            $.s.topChoices.style.display = 'block';
            $.s.topChoicesHd.style.display = 'block';
          ...
          populateCreateForm: function (obj) {
            ...
            if ($.v.data.boards.length) {
              ...
              // no boards, so hide headers
              $.s.topChoicesHd.style.display = 'none';
