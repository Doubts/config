// add browser extension client ID for visual search endpoints
...
(function (w, a) {
    ...
    'f': (function () {
      return {
        ...
        xhr: function (o) {
          ...
          xhr.setRequestHeader('Accept-Language', $.w.navigator.language);
          ...
          runSearch: function (r) {
            ...
            if (r.data.img || r.data.u) {
              ...
              if (r.data.u) {
                ...
                request = request + '&client_id=' + $.a.searchClientId;
                ...
                formData.append('client_id=', $.a.searchClientId);
  ...
  // set to true to use local copies of support files (pinmarklet, grid, create, business logic)
  'dev': false,
