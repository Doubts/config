...
# Main window geometry
main_window_geometry = cPickle.loads('\x80\x02csip\n_unpickle_type\nq\x01U\x0cPyQt5.QtCoreq\x02U\nQByteArrayU2\x01\xd9\xd0\xcb\x00\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x05U\x00\x00\x02\xe6\x00\x00\x00\xf0\x00\x00\x00 \x00\x00\x04\xe3\x00\x00\x02\xe5\x00\x00\x00\x00\x02\x00\x00\x00\x05V\x85\x87Rq\x03.')
...
main_search_history = cPickle.loads('\x80\x02]q\x01X\x06\x00\x00\x00Pythonq\x02a.')
 
# viewer search history
# Search history for the e-book viewer
viewer_search_history = cPickle.loads('\x80\x02]q\x01X\x04\x00\x00\x00niceq\x02a.')
